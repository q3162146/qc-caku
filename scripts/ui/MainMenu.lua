    ...
    local titleBlock = UI.Panel {
        ...
        children = {
            UI.Label {
                text = "桃素洛无幽",
                fontSize = 44,
                fontColor = { 48, 30, 16, 255 },
                fontWeight = "bold",
                letterSpacing = 2,
                textAlign = "center",
                width = "100%",
                textStroke = { width = 2.4, color = { 225, 185, 80, 230 } },
            },
            UI.Label {
                text = "素女篇",
                fontSize = 30,
                fontColor = { 62, 40, 20, 255 },
                fontWeight = "bold",
                letterSpacing = 1.5,
                textAlign = "center",
                width = "100%",
                marginTop = 8,
                textStroke = { width = 1.8, color = { 225, 185, 80, 220 } },
            },
            UI.Label {
                text = "一个关于等待、遗忘与重逢的故事",
                fontSize = 20,
                fontColor = { 96, 64, 40, 255 },
                fontWeight = "bold",
                letterSpacing = 0.8,
                textAlign = "center",
                width = "100%",
                marginTop = 16,
                textStroke = { width = 1.2, color = { 240, 225, 190, 200 } },
            },
        },
    }
