...
| 版本 | 日期 | 变更摘要 |
|------|------|---------|
| v0.3.10-review | 2026-09-02 | 游戏说明改为自动存档口径；主菜单新增「剧情回顾」；新增七段完整剧情滚动面板。LSP 目标文件 0 Error、官方构建成功、validate lua_errors=0；真机截图待补 |
| v0.3.9-ui | 2026-08-31 | 统一底部面板；对话 2 行分页；字幕半透明抬高；三选右侧立绘；主菜单素女封面分层；章节卡整屏场景底 |
| v0.3.8-ui | 2026-08-31 | 视频字幕+章回名；对话去黑底加大字；三选应景背景。白模换真模未做 |
| v0.3.7-ship | 2026-08-31 | 发布前低风险清理：删 VIDEO_SOURCES 未用 S6/S10~S13；移除 VideoSpike/F6 入口；spike 测试片与 CGT 中间产物移出 assets。竖屏 Portrait 仍在。LSP / 官方构建见本轮 |
| v0.3.6-qa | 2026-08-30 | 真机验收遗留 3 项：P99 结局段跳过章节卡；P11 只计五行花（忽略 Int_oldman）+ fire 移到主路东侧 + 拾取半径 1.6；清掉调试触屏按钮/场景横幅/SaveMenu 入口/RunJump，保留移动摇杆。LSP 0 Error、官方构建成功 |
