...
--- Appearance
---@field backgroundColor? RGBAColor|false Background color or false to disable
...
---@field imageTint? RGBAColor Tint color for background image (multiplicative blend)
...
---@field borderColor? RGBAColor Border color (uniform)
...
---@field borderTopColor? RGBAColor Top border color
---@field borderBottomWidth? number Bottom border width
---@field borderBottomColor? RGBAColor Bottom border color
---@field borderLeftWidth? number Left border width
---@field borderLeftColor? RGBAColor Left border color
---@field borderRightWidth? number Right border width
---@field borderRightColor? RGBAColor Right border color
...
---@field shadowColor? RGBAColor Shadow color
--- Pointer Events
