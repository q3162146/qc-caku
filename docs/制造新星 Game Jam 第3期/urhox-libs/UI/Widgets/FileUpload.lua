...
---@field dropzoneBgColor? table Drop zone background color (default: surfaceAlt)
---@field dropzoneBorderColor? table Drop zone border color
---@field dropzoneBorderWidth? number Drop zone border width (default: 2)
---@field dropzoneHoverBorderColor? table Drop zone hover border color
---@field dropzoneDraggingBorderColor? table Drop zone dragging border color
---@field dropzoneBorderStyle? string "solid" | "dashed" (default: "dashed")
---@field iconSize? number Icon wrapper size (default: 46)
---@field iconBgColor? table Icon wrapper background color
---@field iconColor? table Icon color (default: textSecondary)
...
---@field labelTextColor? table Label text color
---@field hintTextColor? table Hint text color
