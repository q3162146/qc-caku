...
---@field borderColor? table Default border color
---@field borderWidth? number Default border width
---@field focusedBorderColor? table Focused border color
---@field focusedBorderWidth? number Focused border width
---@field filledBorderColor? table Filled border color
---@field filledBorderWidth? number Filled border width
---@field errorBorderColor? table Error border color
---@field errorBorderWidth? number Error border width
---@field disabledBorderColor? table Disabled border color
---@field disabledBorderWidth? number Disabled border width
---@field focusedBgColor? table Focused background color
---@field filledBgColor? table Filled background color
---@field disabledBgColor? table Disabled background color
---@field textColor? table Text color
---@field placeholderColor? table Placeholder text color
---@field disabledTextColor? table Disabled text color
---@field cursorColor? table Cursor color
---@field selectionBgColor? table Selection background color
