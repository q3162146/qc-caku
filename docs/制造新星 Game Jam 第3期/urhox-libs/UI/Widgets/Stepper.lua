...
---@field completedBgColor? table Completed step icon background color
---@field completedBorderColor? table Completed step icon border color
---@field completedTextColor? table Completed step icon text color
---@field completedBoxShadow? table|false Completed step icon shadow
---@field activeBgColor? table Active step icon background color
---@field activeBorderColor? table Active step icon border color
---@field activeTextColor? table Active step icon text color
...
---@field pendingBgColor? table Pending step icon background color
---@field pendingBorderColor? table Pending step icon border color
---@field pendingTextColor? table Pending step icon text color
---@field pendingBoxShadow? table|false Pending step icon shadow
---@field errorBgColor? table Error step icon background color
---@field errorBorderColor? table Error step icon border color
---@field errorTextColor? table Error step icon text color
---@field errorBoxShadow? table|false Error step icon shadow
---@field connectorColor? table Connector line color
---@field completedConnectorColor? table Completed connector line color
---@field pendingConnectorColor? table Pending connector line color
