...
---@field bgColor? table Container background fill color
---@field headerExpandedBgColor? table Expanded header background color
---@field collapsedHeaderBgColor? table Collapsed header background color
---@field hoverBgColor? table Header hover background color
...
---@field indicatorCollapsedColor? table Indicator color when item is collapsed
---@field indicatorExpandedColor? table Indicator color when item is expanded
---@field contentTextColor? table Text color for string content
...
---@field itemDividerColor? table Divider color between accordion items
---@field headerDividerColor? table Divider color below expanded header
---@field contentDividerColor? table Divider color at top of expanded content
