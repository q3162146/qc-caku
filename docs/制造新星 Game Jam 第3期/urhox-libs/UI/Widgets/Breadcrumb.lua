...
---@field linkColor? table Clickable link text color (default: textSecondary)
---@field hoverColor? table Hovered link text color (default: primary)
---@field currentColor? table Current page text color (default: text)
---@field separatorColor? table Separator text color (default: textSecondary)
