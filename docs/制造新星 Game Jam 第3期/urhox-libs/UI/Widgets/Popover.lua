...
---@field backgroundColor? table Popover background color
...
---@field titleTextColor? table Title text color
---@field contentTextColor? table Content text color
---@field arrowColor? table Arrow color (defaults to backgroundColor)
