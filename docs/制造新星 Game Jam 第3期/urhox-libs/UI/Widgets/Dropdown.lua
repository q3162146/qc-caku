...
---@field itemHoverBgColor? table Hover item background color
---@field itemHoverTextColor? table Hover item text color
...
---@field itemSelectedColor? table Selected item background color (defaults to itemHoverBgColor)
---@field itemSelectedTextColor? table Selected item text color (defaults to primary)
---@field itemSelectedBorderRadius? number|table Selected item background radius
---@field hoverBorderColor? table Trigger hover border color (default: primary)
---@field openBorderColor? table Trigger open/selected border color (default: primary)
...
---@field popupBorderColor? table Popup panel border color (default: border)
---@field selectedFontWeight? string Font weight for selected item text (default: fontWeight)
---@field triggerBgColor? table Trigger idle background color (default: surface)
---@field arrowColor? table Arrow/chevron idle color (default: textSecondary)
