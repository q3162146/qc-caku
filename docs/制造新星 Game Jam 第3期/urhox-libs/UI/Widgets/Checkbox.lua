...
---@field uncheckedBorderColor? table Unchecked border color
---@field uncheckedHoverBorderColor? table Unchecked hover border color
---@field checkedBorderColor? table Checked border color
---@field checkedHoverBorderColor? table Checked hover border color
---@field uncheckedBgColor? table Unchecked background color
---@field uncheckedHoverBgColor? table Unchecked hover background color
---@field checkedHoverBgColor? table Checked hover background color
---@field checkedPressedBgColor? table Checked pressed background color
