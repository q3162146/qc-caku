...
---@field backgroundColor? table Background color (default: surface)
---@field headerBgColor? table Header background color
...
---@field titleTextColor? table String header title text color
---@field contentTextColor? table Built-in navigation item text color
---@field footerTextColor? table String footer text color
---@field closeIconColor? table Close icon color
---@field closeButtonBgColor? table Close button background color
---@field closeButtonHoverBgColor? table Close button hover background color
---@field itemBgColor? table Built-in navigation item background color
---@field itemHoverBgColor? table Built-in navigation item hover background color
---@field itemSelectedBgColor? table Built-in navigation item selected background color
