...
---@field primaryColor? table Primary color override
...
---@field placeholderColor? table Field placeholder text color
---@field iconColor? table Built-in field icon color
...
---@field todayIconColor? table Today button icon color
...
---@field navBtnHoverBgColor? table Navigation button hover background color
---@field dayHoverBgColor? table Day cell hover background color
