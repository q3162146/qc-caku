...
---@field fieldIdleBorderColor? table Field border color when closed
---@field fieldIdleBorderWidth? number Field border width when closed
---@field fieldOpenBorderColor? table Field border color when popup is open
---@field fieldOpenBorderWidth? number Field border width when popup is open
---@field fieldTextColor? table Field value text color
---@field iconColor? table Field dropdown icon color
...
---@field fieldSwatchBorderColor? table Border color for the color swatch inside the field
...
---@field popupBgColor? table Popup panel background color (default: surface)
...
---@field popupBorderColor? table Popup panel border color
---@field popupBorderWidth? number Popup panel border width
---@field svPickerBorderColor? table Saturation/value picker border color
---@field svPickerBorderWidth? number Saturation/value picker border width
---@field svCursorFillColor? table|false Saturation/value cursor fill color; false disables fill
---@field svCursorBorderColor? table Saturation/value cursor border color
...
---@field sliderBorderColor? table Hue/alpha slider border color
---@field sliderBorderWidth? number Hue/alpha slider border width
---@field presetBorderColor? table Preset swatch border color
---@field presetBorderWidth? number Preset swatch border width
---@field presetHoverBorderColor? table Preset swatch hover border color
