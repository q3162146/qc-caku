...
---@field dotColor? table Inactive dot color (default: {255,255,255,100})
---@field activeDotColor? table Active dot color (default: {255,255,255,255})
---@field dotActiveColor? table Legacy alias for activeDotColor
---@field arrowBorderColor? table Arrow button border color (default: Theme.Color("border"))
...
---@field arrowIconColor? table Arrow icon (chevron) color (default: white)
