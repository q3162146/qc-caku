...
---@field hoverBgColor? table|false Hover background color (false to disable, default: baseColor@10%)
...
---@field buttonBgColor? table Normal button background color for outlined variant (default: transparent)
