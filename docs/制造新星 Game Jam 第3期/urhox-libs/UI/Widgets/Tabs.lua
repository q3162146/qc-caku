...
---@field activeTextColor? table Active tab text color
---@field activeFontWeight? string Font weight for active tab (default: fontWeight)
---@field inactiveTextColor? table Inactive tab text color (default: textSecondary)
---@field lineBorderWidth? number Base line border width for line variant (default: 1)
---@field lineBorderColor? table Base line border color for line variant (default: border)
...
---@field tabHoverBgColor? table Line variant hover background color (default: {128,128,128,20})
---@field tabHoverRadius? number|table Line variant hover border radius, supports per-corner table (default: 0)
---@field tabHoverTextColor? table Line variant hover text color (default: uses normal inactive color)
