...
---@field hoverBgColor? table Node hover background color
---@field hoverRadius? number Node hover/selected highlight border radius
---@field selectedBgColor? table Node selected background color
---@field iconColor? table Node icon color for folder/leaf icons (default: textSecondary)
---@field selectedTextColor? table Selected node text color (default: primary)
