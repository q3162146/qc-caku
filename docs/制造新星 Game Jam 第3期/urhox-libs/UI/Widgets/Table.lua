...
---@field headerTextColor? table Header row text color (default: Theme.Color("text"))
---@field cellTextColor? table Body cell text color (default: Theme.Color("textSecondary"))
---@field headerBorderColor? table Header bottom border color
---@field rowBorderColor? table Body row separator color
---@field columnBorderColor? table Bordered variant column separator color
