...
---@field color? string|table Item color (theme name or RGBA table)
---@field titleColor? string|table Item title color
---@field descriptionColor? string|table Item description color
---@field timeColor? string|table Item time/label color
---@field dotBorderColor? string|table|false Item dot border color
...
---@field lineColor? table Connector line color (default: border)
---@field dotColor? table Dot color (default: primary)
...
---@field titleColor? string|table Title text color
---@field hoverTitleColor? string|table Hovered title text color
---@field descriptionColor? string|table Description text color
---@field timeColor? string|table Time/label text color
---@field dotBorderColor? string|table|false Dot border color
