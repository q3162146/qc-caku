...
---@field activeColor? table Color for active stars (default: warning)
---@field inactiveColor? table Color for inactive stars (default: border)
---@field hoverColor? table Color for hovered stars
